...
class ShopRestList extends StatefulWidget {
  final String title;

  const ShopRestList({Key key, this.title}) : super(key: key);
  @override
  _ShopRestListState createState() => _ShopRestListState();
}

class _ShopRestListState extends State<ShopRestList>
  ...
  void initState() {
    ...
    _isLiked = List.filled(exampleList.length, false, growable: true);
    super.initState();
    setState(() {});
  }
        ...
        floatingActionButton: CircularMenu(
          ...
          items: [
            ...
            CircularMenuItem(
              ...
              onTap: () => App.pushTo(
                  context: context,
                  screen: ShopRestCategory(title: widget.title)),
              color: appLightColor,
              iconColor: Colors.white,
            ),
            CircularMenuItem(
