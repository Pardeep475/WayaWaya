...
CampaignElement campaignElementFromJson(String str) => CampaignElement.fromJson(json.decode(str));

String campaignElementToJson(CampaignElement data) => json.encode(data.toJson());
...
class CampaignElement {
  ...
  factory CampaignElement.fromJson(Map<String, dynamic> json) => CampaignElement(
    description: List<Description>.from(json["description"].map((x) => Description.fromJson(x))),
    name: List<Description>.from(json["name"].map((x) => Description.fromJson(x))),
    format: List<Description>.from(json["format"].map((x) => Description.fromJson(x))),
    url: List<Description>.from(json["url"].map((x) => Description.fromJson(x))),
    text: List<Description>.from(json["text"].map((x) => Description.fromJson(x))),
    order: json["order"],
    imageId: List<ImageId>.from(json["image_id"].map((x) => ImageId.fromJson(x))),
    urlLinkAlias: List<Description>.from(json["url_link_alias"].map((x) => Description.fromJson(x))),
    type: json["type"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "url_link_alias": List<dynamic>.from(urlLinkAlias.map((x) => x.toJson())),
    "type": type,
