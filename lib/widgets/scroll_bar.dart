...
class _QuickScrollBarState extends State<QuickScrollBar> {
  ...
  var scrollBarHeight;
  var contactRowSize = 184.0; //NOTE: size items
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: (index == scrollBarPosSelected)
              ? TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.grey[700])
              : TextStyle(fontSize: 10, fontWeight: FontWeight.w400, color: Colors.grey[500]),
        ),
      ),
    );
  }
